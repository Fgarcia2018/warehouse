const APIENTRADAS='https://warehouseproject.wuaze.com/apiEntradas';
const APISALIDAS='https://warehouseproject.wuaze.com/apiSalidas';
...
async function enviarDatos(){   
      ...
      const response=await fetch('https://warehouseproject.wuaze.com/docs/subirDocumento',{
          method:'POST',
          body:formdata
  });
